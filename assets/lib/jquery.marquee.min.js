...
(function(f) {
    f.fn.marquee = function(x) {
        return this.each(function() {
            ...
            if ("string" === typeof x)
                f.isFunction(p[x]) && (c || (c = b.find(".js-marquee-wrapper")),
                ...
                if (u) {
                    ...
                    h = b.width(),
                    a.startVisible && !a.duplicated ? (a._completeDuration = (parseInt(k, 10) + parseInt(h, 10)) / parseInt(h, 10) * a.duration,
                ...
                if (a.allowCss3Support) {
                    var l = document.body || document.createElement("div")
                      ...
                      , d = ""
                      , r = "";
                    l.style.animation && (r = "@keyframes " + g + " ",
                    n = !0);
                    if (!1 === n)
                ...
                var w = function() {
                    ...
                    a.duration = u ? "up" == a.direction ? a.duration + m / (q / a.duration) : 2 * a.duration : "left" == a.direction ? a.duration + h / (k / a.duration) : 2 * a.duration,
                    ...
                    e++));
                    u ? a.duplicated ? (2 < e && c.css("margin-top", "up" == a.direction ? 0 : "-" + q + "px"),
                    t = {
                    ...
                    }) : a.duplicated ? (2 < e && c.css("margin-left", "left" == a.direction ? 0 : "-" + k + "px"),
                    t = {
